...
// import InsEducation from './Components/Education/InsEducation';
// import ShowEducation from './Components/Education/ShowEducation';
    ...
    <div className="App">
      <Router>
        <Switch>          
          ...
          {/* <Route exact path="/InsEdu" component={InsEducation}></Route>
          <Route exact path="/ShowEdu" component={ShowEducation}></Route> */}
